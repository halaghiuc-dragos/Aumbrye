...
MATERIALS = [
    ...
    ("reforging_stone", "Reforging Stone", 4, 85, "Worn concave by use. Every stroke takes something out and puts nothing back."),
    ...
    ("hardening_quench", "Hardening Quench", 3, 34, "Water from under the fortress. It has been cold for a very long time."),
    ...
    ("vault_sealing_wax", "Vault Sealing Wax", 2, 20, "Red, brittle, and stamped with an office that no longer exists."),
