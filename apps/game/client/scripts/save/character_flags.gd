...
const REGISTRY: Dictionary = {
	...
	"lore_discoveries": {"kind": Kind.DICT, "default": {}},
	...
	"rescue_committed_halbrek": {"kind": Kind.BOOL, "default": false},
	"rescue_committed_ivo": {"kind": Kind.BOOL, "default": false},
	"rescue_committed_nettle": {"kind": Kind.BOOL, "default": false},
	"rescue_committed_corrin": {"kind": Kind.BOOL, "default": false},
	"rescue_committed_odile": {"kind": Kind.BOOL, "default": false},
	"rescue_committed_veil": {"kind": Kind.BOOL, "default": false},
	"rescue_deferred_halbrek": {"kind": Kind.BOOL, "default": false},
	"rescue_deferred_ivo": {"kind": Kind.BOOL, "default": false},
	"rescue_deferred_nettle": {"kind": Kind.BOOL, "default": false},
	"rescue_deferred_corrin": {"kind": Kind.BOOL, "default": false},
	"rescue_deferred_odile": {"kind": Kind.BOOL, "default": false},
	"rescue_deferred_veil": {"kind": Kind.BOOL, "default": false},
