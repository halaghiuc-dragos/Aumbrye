...
- **exit_criteria:**
  ...
  - [ ] 3 enemy types + traps
  - [ ] 2-phase boss
  - [ ] Temporary grid inventory with pickups
  - [ ] Local JSON save with schemaVersion
  - [ ] External friend can complete a run
...
- **acceptance_criteria:**
  - [ ] ≥6 distinct room scenes with navigation bounds
  - [ ] Consistent doorway socket convention documented
- **out_of_scope:**
  - Final art pass
...
- **acceptance_criteria:**
  - [ ] Player can traverse entrance to boss door
  - [ ] Secret is findable without guide (subtle cue)
  - [ ] Shortcut reconnects early/late areas
- **out_of_scope:**
  - Procedural assembly
...
- **acceptance_criteria:**
  - [ ] Fixture validates
  - [ ] Room ids match scene names/templates
- **out_of_scope:**
  - Generator
...
- **acceptance_criteria:**
  - [ ] Builder produces playable castle from fixture alone
  - [ ] Entrance spawn works
- **out_of_scope:**
...
- **acceptance_criteria:**
  - [ ] Spawns in combat rooms
  - [ ] Returns to patrol if player loses aggro per data
- **out_of_scope:**
  - Group coordination
...
- **acceptance_criteria:**
  - [ ] Projectile can be rolled through
  - [ ] Readable draw telegraph
- **out_of_scope:**
  - Homing missiles
...
- **acceptance_criteria:**
  - [ ] Frontal light attacks largely mitigated
  - [ ] Parry or rear attack opens them
- **out_of_scope:**
  - Perfect block AI
...
- **acceptance_criteria:**
  - [ ] Both traps appear in slice
  - [ ] Can be avoided by observation
- **out_of_scope:**
...
- **acceptance_criteria:**
  - [ ] Pick up item into grid
  - [ ] Equip sword from inventory
  - [ ] Gamepad can move cursor and confirm
- **out_of_scope:**
...
- **primary_paths:**
  - `content/schemas/item_instance.schema.json`
  - `content/schemas/inventory.schema.json`
- **agent_instructions:**
  - Add schemas; validate sample items.
- **acceptance_criteria:**
  - [ ] Schemas in CI validator
- **out_of_scope:**
  - Affix pools
...
- **acceptance_criteria:**
  - [ ] Boss fight reachable and completable
...
- **acceptance_criteria:**
  - [ ] Phase transition always triggers at threshold
  - [ ] New attack unique to phase 2
  - [ ] Hazard telegraphed
- **out_of_scope:**
  - 3+ phases
...
- **acceptance_criteria:**
  - [ ] Full loop playable without console errors
  - [ ] Death returns to hub stub with message
- **out_of_scope:**
  - Meta progression
...
- **acceptance_criteria:**
  - [ ] Restart game restores inventory/equipment
...
- **acceptance_criteria:**
  - [ ] Biome ambience plays in dungeon
  - [ ] Boss music starts on fight begin
- **out_of_scope:**
...
6. Friend playtest → exit criteria
