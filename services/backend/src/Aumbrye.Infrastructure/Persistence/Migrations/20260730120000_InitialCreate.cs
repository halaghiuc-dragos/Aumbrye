...
/// <summary>
/// API-3.1 initial schema — accounts, refresh tokens, runs, save blobs.
/// Apply with: dotnet ef database update --project src/Aumbrye.Infrastructure --startup-project src/Aumbrye.Api
/// </summary>
public partial class InitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(name: "IX_RefreshTokens_AccountId", table: "RefreshTokens", column: "AccountId");
        migrationBuilder.CreateIndex(name: "IX_RefreshTokens_TokenHash", table: "RefreshTokens", column: "TokenHash");
        migrationBuilder.CreateIndex(name: "IX_Runs_AccountId_Status", table: "Runs", columns: new[] { "AccountId", "Status" });
    }
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropTable(name: "SaveBlobs");
